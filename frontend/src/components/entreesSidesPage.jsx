...
function EntreesSidesPage({ isInitialized, setIsInitialized, navigate }) {
    ...
    const handleSuperGreensSideClick = () => {
        handleButtonClick('Super Greens Side');
    }
    ...
    const handleSuperGreensEntreeClick = () => {
        handleButtonClick('Super Greens Entree');
    }
    ...
    return (
        ...
        <div style={buttonContainerStyle}>
            ...
            <button style={buttonStyle} onClick={handleSuperGreensSideClick}>Super Greens Side</button>
        </div>
        <h1 style={{ textAlign: 'center', fontSize: '36px', fontFamily: 'Arial, sans-serif' }}>
            Entrees
        </h1>
        <div style={buttonContainerStyle}>
            ...
            <button style={buttonStyle} onClick={handleSuperGreensEntreeClick}>Super Greens Entree</button>
        </div>
...
export default EntreesSidesPage;